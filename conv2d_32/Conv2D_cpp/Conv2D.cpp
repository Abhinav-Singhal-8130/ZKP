...
NULL,
NULL };
uint get_main_input_signal_start() {return 9605;}

uint get_main_input_signal_no() {return 30028;}

uint get_total_signal_no() {return 1432213;}

uint get_number_of_components() {return 67229;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 289337;}
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 30028;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[67228]{0};
}
...
{
uint aux_create = 0;
int aux_cmp_num = 28812+ctx_index+1;
uint csoffset = mySignalStart+587060;
uint aux_dimensions[4] = {98,98,3,1};
for (uint i = 0; i < 28812; i++) {
...
{
uint aux_create = 28812;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+39632;
uint aux_dimensions[4] = {98,98,3,1};
for (uint i = 0; i < 28812; i++) {
...
{
uint aux_create = 57624;
int aux_cmp_num = 57624+ctx_index+1;
uint csoffset = mySignalStart+1364984;
uint aux_dimensions[3] = {98,98,1};
for (uint i = 0; i < 9604; i++) {
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((((294 * Fr_toInt(&lvar[6])) + (3 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 0) + 0);
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((((300 * ((Fr_toInt(&lvar[6]) * 1) + Fr_toInt(&lvar[10]))) + (3 * ((Fr_toInt(&lvar[7]) * 1) + Fr_toInt(&lvar[11])))) + (1 * Fr_toInt(&lvar[8]))) + 9604)]);
}
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((((9 * Fr_toInt(&lvar[10])) + (3 * Fr_toInt(&lvar[11]))) + (1 * Fr_toInt(&lvar[8]))) + 0) + 39604)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matElemMul_0_run(mySubcomponents[cmp_index_ref],ctx);
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((((294 * Fr_toInt(&lvar[6])) + (3 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 0) + 28812);
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((((294 * Fr_toInt(&lvar[6])) + (3 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 0) + 0)]].signalStart + (((3 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((((98 * Fr_toInt(&lvar[6])) + (1 * Fr_toInt(&lvar[7]))) + 0) + 57624);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[9])) + 1)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((((294 * Fr_toInt(&lvar[6])) + (3 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[9]))) + 0) + 28812)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((((98 * Fr_toInt(&lvar[6])) + (1 * Fr_toInt(&lvar[7]))) + 0) + 0)];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((((98 * Fr_toInt(&lvar[6])) + (1 * Fr_toInt(&lvar[7]))) + 0) + 57624)]].signalStart + 0],&signalValues[mySignalStart + 39631]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
