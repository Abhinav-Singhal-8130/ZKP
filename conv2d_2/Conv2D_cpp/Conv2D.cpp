...
NULL,
NULL };
uint get_main_input_signal_start() {return 1801;}

uint get_main_input_signal_no() {return 3128;}

uint get_total_signal_no() {return 265929;}

uint get_number_of_components() {return 12601;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 51729;}
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 3128;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[12600]{0};
}
...
uint csoffset = mySignalStart+107528;
uint aux_dimensions[4] = {30,30,3,2};
for (uint i = 0; i < 5400; i++) {
...
uint csoffset = mySignalStart+4928;
uint aux_dimensions[4] = {30,30,3,2};
for (uint i = 0; i < 5400; i++) {
...
{
uint aux_create = 10800;
int aux_cmp_num = 10800+ctx_index+1;
uint csoffset = mySignalStart+253328;
uint aux_dimensions[3] = {30,30,2};
...
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[4]); // line circom 21
while(Fr_isTrue(&expaux[0])){
{
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((((180 * Fr_toInt(&lvar[6])) + (6 * Fr_toInt(&lvar[7]))) + (2 * Fr_toInt(&lvar[8]))) + (1 * Fr_toInt(&lvar[9]))) + 0);
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((((96 * ((Fr_toInt(&lvar[6]) * 1) + Fr_toInt(&lvar[10]))) + (3 * ((Fr_toInt(&lvar[7]) * 1) + Fr_toInt(&lvar[11])))) + (1 * Fr_toInt(&lvar[8]))) + 1800)]);
}
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((((18 * Fr_toInt(&lvar[10])) + (6 * Fr_toInt(&lvar[11]))) + (2 * Fr_toInt(&lvar[8]))) + (1 * Fr_toInt(&lvar[9]))) + 4872)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matElemMul_0_run(mySubcomponents[cmp_index_ref],ctx);
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((((180 * Fr_toInt(&lvar[6])) + (6 * Fr_toInt(&lvar[7]))) + (2 * Fr_toInt(&lvar[8]))) + (1 * Fr_toInt(&lvar[9]))) + 5400);
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((((180 * Fr_toInt(&lvar[6])) + (6 * Fr_toInt(&lvar[7]))) + (2 * Fr_toInt(&lvar[8]))) + (1 * Fr_toInt(&lvar[9]))) + 0)]].signalStart + (((3 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &lvar[9];
// load src
Fr_add(&expaux[0],&lvar[9],&circuitConstants[2]); // line circom 21
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[9],&circuitConstants[4]); // line circom 21
...
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[4]); // line circom 37
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[9];
// load src
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((((60 * Fr_toInt(&lvar[6])) + (2 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 10800);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[9])) + 1)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((((180 * Fr_toInt(&lvar[6])) + (6 * Fr_toInt(&lvar[7]))) + (2 * Fr_toInt(&lvar[9]))) + (1 * Fr_toInt(&lvar[8]))) + 5400)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((((60 * Fr_toInt(&lvar[6])) + (2 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 0)];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((((60 * Fr_toInt(&lvar[6])) + (2 * Fr_toInt(&lvar[7]))) + (1 * Fr_toInt(&lvar[8]))) + 10800)]].signalStart + 0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[8])) + 4926)]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[2]); // line circom 37
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[4]); // line circom 37
